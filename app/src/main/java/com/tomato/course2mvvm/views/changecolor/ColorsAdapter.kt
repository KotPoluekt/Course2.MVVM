...
import com.tomato.course2mvvm.databinding.ItemColorBinding
import com.tomato.course2mvvm.model.colors.NamedColor

class ColorsAdapter(private val listener: Listener): RecyclerView.Adapter<ColorsAdapter.Holder>(), View.OnClickListener {
